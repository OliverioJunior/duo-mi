    ...
    return(
        <div className='meioSuperior'>
           ...
           <div className="redesSociais">
                ...
                <a dangerouslySetInnerHTML={{ __html: '' }} href='https://www.behance.net/estudioduomi?tracking_source=search_projects%7Cduomi%20' rel="noreferrer"  target ='_blank' class='behance'></a>
